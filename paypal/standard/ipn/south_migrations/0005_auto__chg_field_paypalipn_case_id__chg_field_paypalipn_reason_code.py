...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'paypal_ipn', 'case_id', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'PayPalIPN.reason_code'
        db.alter_column(u'paypal_ipn', 'reason_code', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'case_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            ...
            'reason_code': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
